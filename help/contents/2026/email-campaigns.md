---
title: 針對電子郵件行銷活動使用GenStudio for Performance Marketing和Marketo
description: 瞭解GenStudio如何與Marketo整合，以簡化電子郵件促銷活動、增強共同作業，並最佳化行銷績效。
...
# 針對電子郵件行銷活動使用GenStudio for Performance Marketing和Marketo
